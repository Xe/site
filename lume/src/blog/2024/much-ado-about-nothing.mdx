...
This article flopped so hard that there's a "Maintainers leaving" milestone: [https://github.com/NixOS/nixpkgs/milestone/27?closed=1](https://github.com/NixOS/nixpkgs/milestone/27?closed=1). That person that wrote the "leaving the Determinate Systems community" one also ended up writing this epic "I'm quitting" message that was totally misinterpreted: [https://paste.shark-harmonic.ts.net/paste/abd339e0-2317-402b-8d8e-97e580537263/md](https://paste.shark-harmonic.ts.net/paste/abd339e0-2317-402b-8d8e-97e580537263/md).
