...
<Conv name="Cadey" mood="coffee">
  Well, yes, but that's a very small number of AI scrapers. Most of them want to
  appear as a browser to get around the most basic of bot protections because a
  lot of servers have [dubious logic around "Mozilla" being in the User-Agent
