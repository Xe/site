...
In Blade Runner, the true horror was not the technology. The technology worked fine. The horror was the deployment and the societal implications around making people disposable.

I wonder what underclass of people like that exists today.
...
From here something like this has many obvious and immediate usecases. It's quite literally a universal lingua francia for integrating any square peg into any other round hole. I guess the big directions I could go from here include:
