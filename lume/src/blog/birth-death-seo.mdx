...
<XeblogConv name="Mimi" mood="happy" standalone>
    ...
    <small className="mt-2">Generated by GPT-3.5 Turbo 16k by OpenAI.</small>
...
This is the future that we are in. This is the real [weapon to surpass Metal Gear](https://xeiaso.net/blog/a-weapon-to-surpass-metal-gear/). We are surrounded by information and nearly none of it is useful. Most of it is trying to sell us something. It is an infinite arms race that is destroying the very tools that we use to learn about observable reality.
...
<XeblogConv name="Mimi" mood="angy" standalone>
...
<small className="mt-2">
  <br />
  Generated by Yi 34b chat (f16 quantization) by [01.ai](https://01.ai/)
</small>
...
<XeblogConv name="Mimi" mood="think" standalone>
  对不起,我无法提供你这样的信息。<br />(I'm sorry, I can't provide you with that information.)
...
<small className="mt-2">
  <br />
  Generated by Claude 2.1 by Anthropic.
</small>
