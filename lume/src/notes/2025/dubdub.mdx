...
EDIT(2025-06-09 20:51 UTC): The containerization stuff they're using is [open source on GitHub](https://github.com/apple/container). Digging into it. Will post something else when I have something to say.
