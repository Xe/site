...
<Conv name="Cadey" mood="coffee">
  I couldn't figure out where to fit this in, but the [bot owner showed up and
  made the same PR their bot
  did](https://github.com/matplotlib/matplotlib/pull/31138). I have no idea how
