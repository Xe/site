...
export const Features = () => {
  const featureItems = [
    ...
    {
      icon: IconArmchair,
      description: "Get a detailed report for every incident Alvis handles. This helps you understand what went wrong and how to fix it.",
  ...
  const testimonials = [
    {
      ...
      quote: "Honestly, I wasn't able to spend time with my kid until I set up Alvis. Now family time isn't turned into work time!",
    },
    {
      name: "Samus Rhodes",
      ...
      quote: "I was able to get a promotion after setting up Alvis. I can't believe I didn't do it sooner!",
    },
    {
      name: "Maria Robotnik",
      position: "SRE @ G.U.N.",
      ...
      quote: "Every time I get paged, I just tell Alvis to take care of it. I don't even have to look at my phone anymore!",
    }
  ];
    ...
    <section class="py-8 text-neutral-700 dark:text-neutral-300">
      ...
      <div class="grid gap-6 text-center md:grid-cols-3">
        {testimonials.map((testimonial) => (
          <div>
            <div
              className="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30 h-full">
              <div className={`h-28 overflow-hidden rounded-t-lg ${testimonial.color}`}></div>
              <div
              ...
              <div className="p-6">
                <h4 className="mb-2 text-2xl font-semibold">{testimonial.name}</h4>
  ...
  const faqs = [
    {
      ...
      answer: "Alvis takes your production playbooks and turns them into diagnostic and remediation scripts. It then runs them when you get paged. If it's able to fix the problem, it closes the incident. Otherwise it escalates to you.",
    },
    {
      question: "What AI does Alvis use?",
      answer: "Alvis uses the latest and greatest in large language model technology. It's all developed in-house and is not a wrapper to other services. This ensures your data is safe and secure with Alvis.",
    },
    {
      question: "What is the connection between Alvis and the Rhadamanthus organization?",
      answer: "Alvis is a completly separate entity from Rhadamanthus. We are not affiliated with them in any way. We wish them luck with Project Exodus and their conflicts with the Saviorites.",
    },
    {
      question: "What happens when I go over the number of incidents in my plan?",
      answer: "Alvis will automatically escalate your incidents to the oncall engineer. This ensures that Alvis is fast and ready for everyone!",
    }
  ]
  return (
    <div className="mx-auto max-w-7xl px-6 py-12 sm:pt-16 lg:px-8 lg:py-40">
      <div className="lg:grid lg:grid-cols-12 lg:gap-8">
        <div className="lg:col-span-5">
          <h2 className="text-2xl font-bold leading-10 tracking-tight text-stone-950 dark:text-stone-50">Frequently asked questions</h2>
          <p className="mt-4 text-base leading-7">
            Can’t find the answer you’re looking for? Reach out to our{' '}
            <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-500 visited:text-indigo-600">
              customer support
            </a>{' '}
            team.
          </p>
          ...
          <dl className="space-y-10">
            {faqs.map((faq) => (
              <div key={faq.question}>
                <dt className="text-base font-semibold leading-7 text-stone-800 dark:text-stone-400">{faq.question}</dt>
              ...
              <div>
                <div className="flex items-center justify-between gap-x-4">
                  <h3
                    id={tier.id}
                    className={classNames(
                      tier.mostPopular ? 'text-indigo-600 dark:text-indigo-200' : 'text-gray-900 dark:text-gray-100',
                ...
                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600 dark:text-gray-300">
                  {tier.features.map((feature) => (
                    <li key={feature} className="flex gap-x-3">
                      <CheckIcon className="h-6 w-5 flex-none stroke-indigo-600" aria-hidden="true" />
                      {feature}
                    </li>
                  ))}
                </ul>
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 pb-8 sm:pb-10 lg:px-8">
      ...
      <div className="mt-10 flex items-center gap-x-6">
        ...
        <a href="/blog/alvis/" className="text-sm font-semibold leading-6 text-gray-900">
