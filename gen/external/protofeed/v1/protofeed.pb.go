...
// 	protoc        (unknown)
// source: external/protofeed/v1/protofeed.proto
...
func (x *Feed) Reset() {
	*x = Feed{}
	mi := &file_external_protofeed_v1_protofeed_proto_msgTypes[0]
...
func (*Feed) Descriptor() ([]byte, []int) {
	return file_external_protofeed_v1_protofeed_proto_rawDescGZIP(), []int{0}
}
...
func (x *Author) Reset() {
	*x = Author{}
	mi := &file_external_protofeed_v1_protofeed_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Author) Descriptor() ([]byte, []int) {
	return file_external_protofeed_v1_protofeed_proto_rawDescGZIP(), []int{1}
}
...
func (x *Item) Reset() {
	*x = Item{}
	mi := &file_external_protofeed_v1_protofeed_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Item) Descriptor() ([]byte, []int) {
	return file_external_protofeed_v1_protofeed_proto_rawDescGZIP(), []int{2}
}
...
func (x *Attachment) Reset() {
	*x = Attachment{}
	mi := &file_external_protofeed_v1_protofeed_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Attachment) Descriptor() ([]byte, []int) {
	return file_external_protofeed_v1_protofeed_proto_rawDescGZIP(), []int{3}
}
...
var File_external_protofeed_v1_protofeed_proto protoreflect.FileDescriptor

const file_external_protofeed_v1_protofeed_proto_rawDesc = "" +
	"\n" +
	"%external/protofeed/v1/protofeed.proto\x12\tprotofeed\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd8\x02\n" +
	"\x04Feed\x12\x14\n" +
	...
	"\x13duration_in_seconds\x18\x05 \x01(\x05R\x11durationInSecondsB\x8c\x01\n" +
	"\rcom.protofeedB\x0eProtofeedProtoP\x01Z'xeiaso.net/v4/gen/external/protofeed/v1\xa2\x02\x03PXX\xaa\x02\tProtofeed\xca\x02\tProtofeed\xe2\x02\x15Protofeed\\GPBMetadata\xea\x02\tProtofeedb\x06proto3"

var (
	file_external_protofeed_v1_protofeed_proto_rawDescOnce sync.Once
	file_external_protofeed_v1_protofeed_proto_rawDescData []byte
)

func file_external_protofeed_v1_protofeed_proto_rawDescGZIP() []byte {
	file_external_protofeed_v1_protofeed_proto_rawDescOnce.Do(func() {
		file_external_protofeed_v1_protofeed_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_external_protofeed_v1_protofeed_proto_rawDesc), len(file_external_protofeed_v1_protofeed_proto_rawDesc)))
	})
	return file_external_protofeed_v1_protofeed_proto_rawDescData
}

var file_external_protofeed_v1_protofeed_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_external_protofeed_v1_protofeed_proto_goTypes = []any{
...
var file_external_protofeed_v1_protofeed_proto_depIdxs = []int32{
...
func init() { file_external_protofeed_v1_protofeed_proto_init() }
func file_external_protofeed_v1_protofeed_proto_init() {
	if File_external_protofeed_v1_protofeed_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_external_protofeed_v1_protofeed_proto_rawDesc), len(file_external_protofeed_v1_protofeed_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_external_protofeed_v1_protofeed_proto_goTypes,
		DependencyIndexes: file_external_protofeed_v1_protofeed_proto_depIdxs,
		MessageInfos:      file_external_protofeed_v1_protofeed_proto_msgTypes,
	}.Build()
	File_external_protofeed_v1_protofeed_proto = out.File
	file_external_protofeed_v1_protofeed_proto_goTypes = nil
	file_external_protofeed_v1_protofeed_proto_depIdxs = nil
}
